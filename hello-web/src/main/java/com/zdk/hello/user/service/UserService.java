package com.zdk.hello.user.service;
...
public interface UserService extends IService<User> {
     ...
     * 方法描述: 分页查询
     * @param userVo
     * @return com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.zdk.hello.user.entity.User>
     * @author zdk
     ...
     * 方法描述: 通过id获取用户数据
     * @param id 用户id
     * @return com.zdk.hello.user.entity.User
     * @author zdk
